...
Note：ノートブック ランタイムには Standard、Advanced、Advanced with GPU サポート の 3 つのオプションがあります。本ハンズオンでは、Standard ランタイムを使⽤します。詳細は[ノートブックのランタイムを指定](https://doc.arcgis.com/ja/arcgis-online/create-maps/specify-the-runtime-of-a-notebook.htm)をご参照ください。
